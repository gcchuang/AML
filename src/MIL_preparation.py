...
train_output = {
      ...
      "grid": uf.get_grid(slide_path,X_train,patches_size,left_proportion,shrink_proportion,patch_num),
      "targets": y_train,
...
val_output = {
      ...
      "grid": uf.get_grid(slide_path,X_val,patches_size,left_proportion,shrink_proportion,patch_num),
      "targets": y_val,
      "mult": patches_size/224,
      "level": level,
  }
...
test_output = {
      ...
      "grid": uf.get_grid(slide_path,X_test,patches_size,left_proportion,shrink_proportion,patch_num),
      "targets": y_test,
      "mult": patches_size/224,
      "level": level,
  }
